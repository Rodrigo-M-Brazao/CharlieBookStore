              ...
              <tr>
                ...
                <td class = "email-adm-tabela">
                  ...
                  <td>
                    <?php
                      $id = $linha["ADM_ID"]; 
                      echo "<button type='button' class='btn btn-primary' style='background: none; border: none; padding: 0;'data-bs-toggle='modal' data-bs-target='#staticBackdrop-editar' onclick = 'showEdit($id)'><i class='fa-solid fa-pen-to-square'></i></button>"; 
                    ?>
                  </td>
              ...
              <form class="form-adm" Action="edita-adm.php" method="POST">
                <div class="modal-body">
                  <div class="form-group">
                    ...
                    <label for="inputAddress">Nome</label>
                    <input name="nome" type="text" class="form-control nome inputNome" id="inputName" placeholder="Nome">
                  </div>
                  <div class="form-row">
                    <div class="email form-group col-md-6">
                      <label for="inputEmail4">Email</label>
                      <input name="email" type="email" class="form-control inputEmail" id="inputEmail4" placeholder="Email">
                    </div>          
                    <div class="senha form-group col-md-6">
                      <label for="inputPassword4">Senha</label>
                      <input name="senha" type="password" class="form-control inputSenha" id="inputPassword4" placeholder="Senha">
                    </div>                 
                  </div>
                  <div class="form-group">
                    <div class="form-check">
